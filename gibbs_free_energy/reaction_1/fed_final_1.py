...
E =  [0.00, -1.10, -2.14, -1.76, -2.06, -2.65, -2.35, -0.88]
E1 = [0.00, -1.90, -3.78, -4.16, -5.27, -6.65, -7.15, -5.65]
...
ax.annotate('-0.80V, pH 14 Electrode', xy = [0.1,min(E+E1) - 0.8], color = 'blue',  fontsize=12)
...
an.draggable()
an = ax.annotate('*O',xy = [8.0,E[7]+0.04], color = 'grey')
#an = ax.annotate('*O + C$_2$H$_4$(gas)',xy = [8.0,E[7]+0.04], color = 'grey')
an.draggable()
#an = ax.annotate('*CH$_3$CH$_2$OH',xy = [9.3,E[7]+0.04], color = 'grey')
#an.draggable()
...
an.draggable()
an = ax.annotate('*O',xy = [8.0,E1[7]+0.04], color = 'blue')
#an = ax.annotate('*O + C$_2$H$_4$(gas)',xy = [8.0,E1[7]+0.04], color = 'blue')
an.draggable()
#an = ax.annotate('*CH$_3$CH$_2$OH',xy = [9.3,E1[7]+0.04], color = 'blue')
#an.draggable()
